      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="mb-12 animate-fade-in">
          ...
          <h2 className="text-5xl md:text-6xl font-bold text-white mb-8 leading-tight">
            Ready to Lead with <span className="wealth-gradient bg-clip-text text-transparent">AI Innovation</span>?
          </h2>
              ...
              {benefits.map((benefit, index) => {
                ...
                return (
                  <div key={index} className="flex flex-col items-center group animate-fade-in" style={{ animationDelay: `${index * 0.1}s` }}>
                    <div className="w-16 h-16 wealth-gradient rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg executive-glow">
